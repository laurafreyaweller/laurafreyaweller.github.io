...
4.	Checking whether the local and remote repositories are connected can be done by going to VSC. There you see the changes you made in the local repository. Here you can add/change text however you like and then commit and push it to the remote repository. This site helped me with that: https://blog.gitnux.com/guides/how-to-push-code-to-github-from-visual-studio-code/
